...
async function fetchFiles() {
  ...
  //   fileRow.className =
  //     "grid grid-cols-4 gap-4 bg-gray-100 p-2 rounded-lg shadow-sm items-center";
  
  //   fileRow.innerHTML = `
  //     <span class="truncate">${file.name}</span>
  //     <span class="text-gray-600">${(file.size / 1024).toFixed(2)} KB</span>
  //     <span class="text-gray-500">${new Date(file.lastModified).toLocaleDateString()}</span>
